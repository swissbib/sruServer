        ...
        <form method="GET" name="SRUForm" onSubmit="mungeForm()">
            ...
            <table cellspacing="0" class="formtable">
                ...
                <tr>
                    ...
                    <td>
                        <input name="x-info-6-facets" type="checkbox" value="true" />
                    </td>
                </tr>

                <tr>
                    <td>Include Spelling Suggestions:</td>
                    <td>
                        <input name="x-info-7-spelling" type="checkbox" value="true" />
                    </td>
                </tr>
                <tr>
                    <td>Lemmatize Search:</td>
                    <td>
                        <input name="x-info-8-lemmatize" type="checkbox" value="true" />
                    </td>
                </tr>
                <tr>
                    <td>Get Holdings:</td>
                    <td>
                        <input name="x-info-10-get-holdings" type="checkbox" value="true" />
                    </td>
                </tr>
            </table>
            <input type="submit" value="Search" onClick="return mungeForm();"/>
